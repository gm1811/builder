        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-20 mb-20 pb-20 border-b border-neutral-900">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-sm font-light">
              <li>
                <Link href="/builder" className="text-white hover:text-neutral-300 transition-colors">
                  Transformación residencial
                </Link>
              </li>
              <li>
                <Link href="/builder/carteras" className="text-white hover:text-neutral-300 transition-colors">
                  Carteras Patrimonialistas
                </Link>
              </li>
              <li>
                <Link href="/builder/proceso" className="text-white hover:text-neutral-300 transition-colors">
                  Proceso
                </Link>
              </li>
              <li>
                <Link href="/builder#proyectos" className="text-white hover:text-neutral-300 transition-colors">
                  Proyectos
                </Link>
              </li>
              <li>
                <Link href="/builder/sobre" className="text-white hover:text-neutral-300 transition-colors">
                  Sobre Revita
                </Link>
              </li>
            </ul>
          ...
          </div>          {/* Contact & Newsletter Column */}
          <div className="lg:col-span-4">
            {/* Contact Button */}
            <div className="mb-12 pb-12 border-b border-neutral-900">
              ...
              <Link
                ...
                className="bg-white hover:bg-neutral-200 text-black text-[11px] font-semibold tracking-[2.5px] uppercase py-3.5 px-6 text-center transition-colors duration-300 block w-full"
              >
                Habla con un asesor
              </Link>
            </div>
              ...
              {newsletterStatus === 'success' ? (
                ...
                <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                  ...
                  <input
                    ...
                    className="bg-transparent border-b border-neutral-800 focus:border-white py-3 text-sm font-light text-white placeholder-neutral-650 focus:outline-none rounded-none"
                  />
