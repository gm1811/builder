...
import { Facebook, Instagram, MapPin, Phone, UtensilsCrossed, ChefHat, Cake, Hash, Loader2, Leaf, ClipboardList, ShoppingBag, Wine, ChevronDown, ChevronUp } from "lucide-react";
...
// Static mock content for quick visuals
...
// Generic mock data matching the UI of the other app
...
const mockMenuItems = [
    { id: "1", title: "Crispy Calamari", description: "Golden fried calamari rings served with house aioli.", imgSrc: "https://images.unsplash.com/photo-1599487405705-8eb747e06ff4?w=400", price: 12.50, category: "entrantes", dietaryTags: ["dairy_free"] },
    { id: "2", title: "Grilled Ribeye Steak", description: "Premium 12oz ribeye with roasted vegetables.", imgSrc: "https://images.unsplash.com/photo-1544025162-d76694265947?w=400", price: 34.00, category: "principales", dietaryTags: ["gluten_free"] },
    { id: "3", title: "Vegan Burger", description: "Plant-based patty, lettuce, tomato, vegan cheese.", imgSrc: "https://images.unsplash.com/photo-1550547660-d9450f859349?w=400", price: 16.00, category: "principales", dietaryTags: ["vegan", "vegetarian"] },
    { id: "4", title: "Cheesecake", description: "New York style cheesecake with strawberry sauce.", imgSrc: "https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=400", price: 8.50, category: "postres", dietaryTags: ["vegetarian"] },
    { id: "5", title: "Craft Beer", description: "Locally brewed IPA.", imgSrc: "https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=400", price: 6.00, category: "bebidas", dietaryTags: [] },
...
function MenuContent() {
    ...
    const tableNumber = searchParams.get("table") || "001";
