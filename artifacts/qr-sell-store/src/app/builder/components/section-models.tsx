  ...
  return (
    <section className="bg-neutral-50 py-12 md:py-16">
      <div className="max-w-[1320px] mx-auto px-6 md:px-10">
        <ScrollReveal>
          <h2 className="font-serif font-light text-3xl md:text-5xl lg:text-6xl text-[#1A1A1A] leading-tight mb-10 md:mb-16 tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
          {models.map((model, idx) => (
            <div
              key={idx}
              className="group bg-white border border-neutral-300 hover:border-black transition-all duration-500 overflow-hidden flex flex-col"
            >
              ...
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-between">
                <div>
                  <div className="text-[10px] md:text-[11px] font-medium tracking-[2px] md:tracking-[3px] uppercase text-neutral-500 mb-3 md:mb-4">
                    {model.label}
                  </div>
                  <h3 className="font-serif text-xl md:text-3xl font-light text-black mb-3 md:mb-5 tracking-tight group-hover:italic transition-all duration-300">
                    {model.title}
                  </h3>
                ...
                <div>
                  <Link
                    href={model.link}
                    className="inline-flex items-center gap-2 md:gap-3 text-[10px] md:text-xs tracking-[1.5px] md:tracking-[2px] uppercase text-[#1A1A1A] font-medium border-b border-black pb-1 transition-all duration-300 group-hover:gap-4 hover:text-neutral-500 hover:border-neutral-500"
                  >
                    Ver detalle →
                  </Link>
                </div>
